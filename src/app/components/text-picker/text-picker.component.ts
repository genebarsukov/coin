...
@Component({
    ...
    styleUrls: [
        ...
        'app/components/text-picker/text-picker.component.css',
        'app/components/text-picker/text-picker-light.component.css',
        'app/components/text-picker/text-picker-dark.component.css'
    ],
    providers: [
        {
